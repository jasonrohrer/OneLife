...
echo "About to clear old bug files on all remote servers (without rebuilding them)"
echo ""
...
do
  ...
  ssh -n $user@$server 'echo Before:; df /;  /home/jcr13/checkout/OneLife/scripts/clearOldBugFiles.sh; echo After:; df /'

...
scp -o StrictHostKeychecking=no linodeGameServerRootSetup.sh root@$subdomain.onehouronelife.com:
...
ssh -o StrictHostKeychecking=no root@$subdomain.onehouronelife.com "./linodeGameServerRootSetup.sh"

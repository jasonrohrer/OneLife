...
sshpass -p "$rootPass" scp -o StrictHostKeychecking=no linodeWebServerRootSetupDebian.sh root@$subdomain.onehouronelife.com:
...
sshpass -p "$rootPass" ssh -o StrictHostKeychecking=no root@$subdomain.onehouronelife.com "./linodeWebServerRootSetupDebian.sh"

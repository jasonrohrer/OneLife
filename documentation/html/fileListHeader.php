...
'echo "<FORM ACTION=http://lineage.onehouronelife.com/server.php METHOD=post><INPUT TYPE=hidden NAME=action VALUE=front_page><INPUT TYPE=hidden NAME=hide_filter VALUE=1><INPUT TYPE=hidden NAME=filter VALUE=$email><INPUT TYPE=hidden NAME=ticket_hash VALUE=$ticket_hash><INPUT TYPE=hidden NAME=string_to_hash VALUE=$stringToHash>See your recent lives in the <INPUT TYPE=Submit VALUE=\"Family Tree\"></FORM><br>"; '.

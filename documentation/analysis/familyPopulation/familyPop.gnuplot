...
plot "1568799648_familyPopLog.txt" using 1:(cumulated(9)) title columnhead(9) with filledcurves x1, "" using 1:(cumulated(8)) title columnhead(8) with filledcurves x1, "" using 1:(cumulated(7)) title columnhead(7) with filledcurves x1, "" using 1:(cumulated(6)) title columnhead(6) with filledcurves x1, "" using 1:(cumulated(5)) title columnhead(5) with filledcurves x1, "" using 1:(cumulated(4)) title columnhead(4) with filledcurves x1, "" using 1:(cumulated(3)) title columnhead(3) with filledcurves x1, "" using 1:(cumulated(2)) title columnhead(2) with filledcurves x1,

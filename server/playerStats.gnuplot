...
plot "playerStatsTrimmed3_ave.dat" using ($1 - ( 8 * 3600 ) ):($2) with filledcurves y1=0 fillcolor rgb "#000000", "" using ($1 - ( 8 * 3600 ) ):($3) with lines lw 3 lt 1 linecolor rgb "#FF0000"
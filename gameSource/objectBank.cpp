        ...
        for( int i=0; i<mapSize; i++ ) {
            if( idMap[i] != NULL ) {
                ...
                if( o->numUses > 1 ) {
                    ...
                    char *spriteUseMap = new char[ o->numSprites ];
                    ...
                    for( int d=1; d<=numDummyObj; d++ ) {
                        ...
                        int numSpritesLeft = 
                            ( d * numVanishingSprites ) / numDummyObj;
                        
                        if( numVanishingSprites > 0 && numSpritesLeft < 1 ) {
                            numSpritesLeft = 1;
                            }
                        ...
                        int numDummySprites = 
                            o->numSprites - ( numVanishingSprites - 
                                              numSpritesLeft );
                        }
